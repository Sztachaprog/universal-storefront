...
def test_update_movie():
    movie_id = create_movie("2024-01-01", True, "pl", "Polski film", "Opis polskiego filmu")
    updated_movies = update_movie("2025-01-01", False, "en", "English Movie", "Description of English movie", movie_id)
    get_updated_movies = get_movie_details(updated_movies, "en")
