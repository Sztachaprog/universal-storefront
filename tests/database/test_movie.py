...
def test_create_movie(cursor):
    ...
    assert movie_details[3] == "pl", f"Expected language_code 'pl', got '{movie_details[3]}'"
    assert movie_details[4] == "Polski film", f"Expected title 'Polski film', got '{movie_details[4]}'"
    assert movie_details[5] == "Opis polskiego filmu", f"Expected description 'Opis polskiego filmu', got '{movie_details[5]}'"
